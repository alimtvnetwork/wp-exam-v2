...
import { Sparkles, Copy, Check, BookOpen, Code2, Sliders } from 'lucide-react';
...
- multiple_choice (options array required, correctAnswer required for quiz)
...
export const AiSectionAssistant: React.FC<AiSectionAssistantProps> = ({ section, title }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto font-sans bg-card text-card-foreground border-border">
