        ...
        {cycleReport.hasCycles ? (
          <div className="rounded-xl border border-destructive/40 bg-destructive/10 p-3 flex items-start gap-2.5 text-xs text-destructive">
            ...
            <div>
              ...
              <p className="text-xs opacity-90 mt-0.5">{cycleReport.description}</p>
            </div>
          </div>
        ) : (
                ...
                >
                  <div className="flex items-center justify-between text-xs pb-2 border-b border-border/40">
                    ...
                    <div className="flex items-center gap-1.5">
                      {isVisible ? (
                        <Badge className="bg-emerald-500/15 text-emerald-500 border border-emerald-500/30 text-xs gap-1">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {Object.entries(field.optionBranching || {}).map(([opt, targetId]) => {
                          ...
                          return (
                            <span
                              key={opt}
                              className="inline-flex items-center gap-1 text-xs px-2 py-0.5 rounded-full bg-indigo-500/10 text-indigo-400 border border-indigo-500/30 font-mono"
                            >
                              <span>"{opt}"</span>
                  ...
                  <div className="mt-2.5 pt-2 border-t border-border/40 flex flex-wrap items-center gap-2">
                    ...
                    {field.type === 'true_false' ? (
                      ...
                      <select
                        ...
                        className="h-6 px-2 text-xs bg-background text-foreground border border-input rounded dark:bg-slate-900 dark:text-slate-100 max-w-[280px]"
                      >
                      ...
                      <input
                        ...
                        className="h-6 px-2 text-xs bg-background text-foreground border border-input rounded dark:bg-slate-900 dark:text-slate-100 max-w-[220px]"
                      />
                    )}
                  </div>
                </div>
