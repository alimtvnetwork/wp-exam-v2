...
**Resolves:** FU-12 from `02-spec/19-main-worker-service/15-rbac-and-status-seed.md` §1.
...
2. New `Categories.MainWorker` category carrying the 27 tunables from `02-spec/19-main-worker-service/16-tunable-constants.md`.
...
| `Categories.MainWorker.*` | add (27 keys) | `02-spec/19/16-tunable-constants.md` §3 | none — new category |
| `Tables.Role` | add (3 rows) | `02-spec/19/15-rbac-and-status-seed.md` §3 | none — new table seed |
...
Concrete row sets are not duplicated here — `02-spec/19/15-rbac-and-status-seed.md` §3 is the single source of truth.

---

## 4. New `Categories.MainWorker` block

Verbatim from `02-spec/19-main-worker-service/16-tunable-constants.md` §3:
...
Mirrors `02-spec/19/15-rbac-and-status-seed.md` §4 — must all pass:
...
- `02-spec/06-seedable-config-architecture/02-fundamentals.md` — `SeedWithVersionCheck` algorithm.
...
- `02-spec/19-main-worker-service/15-rbac-and-status-seed.md` — concrete row sets.
- `02-spec/19-main-worker-service/16-tunable-constants.md` §3 — concrete `MainWorker` category values.
