...
**Resolves:** FU-11 from `02-spec/19-main-worker-service/15-rbac-and-status-seed.md` §3.1.
...
Valid — `EnumPage` block from `02-spec/19/15-rbac-and-status-seed.md` §3:
...
ajv validate \
  ...
  -d 02-spec/19-main-worker-service/15-rbac-and-status-seed.md#section-3
```
...
- `02-spec/06-seedable-config-architecture/02-fundamentals.md` — sibling `Categories` block.
...
- `02-spec/19-main-worker-service/15-rbac-and-status-seed.md` — first concrete consumer.
