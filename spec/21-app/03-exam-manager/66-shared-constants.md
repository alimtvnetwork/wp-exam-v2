...
- Backend Spec: `01-admin-backend/02-split-spec/`
- Error Management: `01-admin-backend/02-split-spec/02-error-management.md`
- REST API: `01-admin-backend/02-split-spec/36-rest-api-endpoints.md`
- Theme System: `01-admin-backend/02-split-spec/56-theming-system.md`
- Caching System: `01-admin-backend/02-split-spec/57-caching-system.md`
- Frontend Theme: `02-frontend/02-split-spec/31-theme-application.md`
