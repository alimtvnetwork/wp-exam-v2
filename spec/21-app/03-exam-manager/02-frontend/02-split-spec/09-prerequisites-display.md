...
| **Backend Prerequisites** | [18-exam-prerequisites-tab](../../01-admin-backend/02-split-spec/18-exam-prerequisites-tab.md) | Admin configuration |
| **Checklist Items** | [19-exam-checklists-tab](../../01-admin-backend/02-split-spec/19-exam-checklists-tab.md) | PRE phase items |
