...
| Backend Invites | [50-exam-invite-management](../../01-admin-backend/02-split-spec/50-exam-invite-management.md) | Admin invite management |
| REST API | [36-rest-api-endpoints](../../01-admin-backend/02-split-spec/36-rest-api-endpoints.md) | Signup endpoint with invite validation |
