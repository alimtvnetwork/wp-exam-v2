...
| **H2 Extraction** | [12-exam-service](../../01-admin-backend/02-split-spec/12-exam-service.md) | Backend section parsing |
| **Wiki Links** | [20-wiki-service](../../01-admin-backend/02-split-spec/20-wiki-service.md) | Wiki link resolution |
