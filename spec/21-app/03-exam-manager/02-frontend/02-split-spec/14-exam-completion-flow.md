...
| **Progress Tracking** | [28-participant-progress](../../01-admin-backend/02-split-spec/28-participant-progress.md) | Backend calculation |
| **Dashboard** | [06-dashboard-page](06-dashboard-page.md) | Shows completion state |
| **Certificate** | [44-certificate-generation](../../01-admin-backend/02-split-spec/44-certificate-generation.md) | Post-completion |
