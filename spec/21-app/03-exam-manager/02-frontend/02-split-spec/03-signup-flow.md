...
|----------|--------|--------------|
| `POST /api/signup` | POST | [27-participant-service](../../01-admin-backend/02-split-spec/27-participant-service.md) |
...
| **Backend Participant** | [27-participant-service](../../01-admin-backend/02-split-spec/27-participant-service.md) | Creates participant record |
