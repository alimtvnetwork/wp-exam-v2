...
|----------|--------|--------------|
| `GET /api/participants/check` | GET | [27-participant-service](../../01-admin-backend/02-split-spec/27-participant-service.md) |
| `POST /api/participate` | POST | [36-rest-api-endpoints](../../01-admin-backend/02-split-spec/36-rest-api-endpoints.md) |
| `POST /api/log-event` | POST | [36-rest-api-endpoints](../../01-admin-backend/02-split-spec/36-rest-api-endpoints.md) |
...
| **Backend Participant** | [27-participant-service](../../01-admin-backend/02-split-spec/27-participant-service.md) | Creates record |
| **Deadline Calculation** | [29-deadline-engine](../../01-admin-backend/02-split-spec/29-deadline-engine.md) | Deadline setup |
