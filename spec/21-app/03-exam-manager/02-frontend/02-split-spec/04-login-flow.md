...
|----------|--------|--------------|
| `POST /api/login` | POST | [36-rest-api-endpoints](../../01-admin-backend/02-split-spec/36-rest-api-endpoints.md) |
| `POST /api/log-event` | POST | [36-rest-api-endpoints](../../01-admin-backend/02-split-spec/36-rest-api-endpoints.md) |
| `POST /api/forgot-password` | POST | [36-rest-api-endpoints](../../01-admin-backend/02-split-spec/36-rest-api-endpoints.md) |
