...
|-------|------|--------------|
| **Backend REST API** | [36-rest-api-endpoints](../../01-admin-backend/02-split-spec/36-rest-api-endpoints.md) | API endpoint definitions |
| **Shared Constants** | [66-shared-constants](../../66-shared-constants.md) | Cookie patterns, API paths |
| **Backend Logging** | [07-logging-system](../../01-admin-backend/02-split-spec/07-logging-system.md) | Server-side log format |
| **Rate Limiting** | [48-rate-limiting](../../01-admin-backend/02-split-spec/48-rate-limiting.md) | API protection |
