...
|----------|--------|---------|--------------|
| `/api/exams/{slug}` | GET | Load exam metadata | [12-exam-service](../../01-admin-backend/02-split-spec/12-exam-service.md) |
| `/api/participants/check` | GET | Check participation status | [27-participant-service](../../01-admin-backend/02-split-spec/27-participant-service.md) |
| `/api/validate-session` | POST | Validate session cookie | [36-rest-api-endpoints](../../01-admin-backend/02-split-spec/36-rest-api-endpoints.md) |
