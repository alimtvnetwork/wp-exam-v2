...
From [SHARED-CONSTANTS.md](../../66-shared-constants.md):
...
|-------|------|--------------|
| **Deadline Engine** | [29-deadline-engine](../../01-admin-backend/02-split-spec/29-deadline-engine.md) | Backend calculation |
| **Deadline Flow Diagram** | [04-deadline-calculation-flow](../../03-diagrams/04-deadline-calculation-flow.md) | Visual flow |
