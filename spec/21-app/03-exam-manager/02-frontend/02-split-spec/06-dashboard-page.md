...
- Uses formula from [28-participant-progress](../../01-admin-backend/02-split-spec/28-participant-progress.md)
...
| **Progress Tracking** | [28-participant-progress](../../01-admin-backend/02-split-spec/28-participant-progress.md) | Progress calculation |
