...
CREATE INDEX IdxRateLimitLookup ON RateLimit(IpAddressHash, Category, WindowEnd);
CREATE INDEX IdxRateLimitCleanup ON RateLimit(WindowEnd);
CREATE INDEX IdxRateLockoutCheck ON RateLockout(IpAddressHash, Category, LockedUntil);
```
