...
function runDeadlineChecker():
    ...
    batchSize = Settings.get('Deadlines.DeadlineCheckerBatchSize', 100)
    processedCount = 0
    errorCount = 0
...
{
    "DeadlineReminders": {
        "SoftDeadlineDaysBefore": [7, 3, 1],
        "HardDeadlineDaysBefore": [3, 1],
...
| **Deadline Flow Diagram** | [diagrams/04-deadline-calculation-flow](../../03-diagrams/04-deadline-calculation-flow.md) | Visual calculation and cron flow |
| **Status State Machine** | [diagrams/02-participant-status-states](../../03-diagrams/02-participant-status-states.md) | Status transitions triggered by deadlines |
