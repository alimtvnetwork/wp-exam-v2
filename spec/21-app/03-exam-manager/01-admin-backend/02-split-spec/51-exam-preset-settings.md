...
CREATE INDEX IF NOT EXISTS IdxExamPresetSlug ON examPreset(slug);
CREATE INDEX IF NOT EXISTS IdxExamPresetCategory ON examPreset(category);
CREATE INDEX IF NOT EXISTS IdxExamPresetIsSeeded ON examPreset(isSeeded);
```
