...
class Schema {
    ...
    private static function createExamPresetTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxExamPresetSlug ON ExamPreset(Slug)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxExamPresetCategory ON ExamPreset(Category)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxExamPresetIsSeeded ON ExamPreset(IsSeeded)");
    }
    ...
    private static function createUserRoleTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxUserRoleUserId ON UserRole(UserId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxUserRoleRole ON UserRole(Role)");
    }
    ...
    private static function createExamTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxExamParentExamId ON Exam(ParentExamId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxExamSlug ON Exam(Slug)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxExamIsEnabled ON Exam(IsEnabled)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxExamIsInviteOnly ON Exam(IsInviteOnly)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxExamPresetId ON Exam(PresetId)");
    }
    ...
    private static function createExamInviteTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxExamInviteExamId ON ExamInvite(ExamId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxExamInviteEmail ON ExamInvite(Email)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxExamInvitePhone ON ExamInvite(Phone)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxExamInviteStatus ON ExamInvite(Status)");
    }
    ...
    private static function createSecretKeyTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxSecretKeyExamId ON SecretKey(ExamId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxSecretKeyKeyHash ON SecretKey(KeyHash)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxSecretKeyIsActive ON SecretKey(IsActive)");
    }
    ...
    private static function createSecretKeyAccessTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxSecretKeyAccessSecretKeyId ON SecretKeyAccess(SecretKeyId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxSecretKeyAccessIpAddressHash ON SecretKeyAccess(IpAddressHash)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxSecretKeyAccessAccessedAt ON SecretKeyAccess(AccessedAt)");
    }
    ...
    private static function createWikiCategoryTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxWikiCategoryParentId ON WikiCategory(ParentId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxWikiCategorySlug ON WikiCategory(Slug)");
    }
    ...
    private static function createWikiTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxWikiSlug ON Wiki(Slug)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxWikiCategoryId ON Wiki(CategoryId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxWikiVisibility ON Wiki(Visibility)");
    }
    ...
    private static function createWikiRevisionTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxWikiRevisionWikiId ON WikiRevision(WikiId)");
    }
    ...
    private static function createEmailTemplateTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxEmailTemplateTemplateKey ON EmailTemplate(TemplateKey)");
    }
    ...
    private static function createEmailQueueTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxEmailQueueStatus ON EmailQueue(Status)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxEmailQueuePriority ON EmailQueue(Priority)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxEmailQueueNextAttemptAt ON EmailQueue(NextAttemptAt)");
    }
    ...
    private static function createExamPrerequisiteTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxExamPrerequisiteExamId ON ExamPrerequisite(ExamId)");
    }
    ...
    private static function createExamChecklistTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxExamChecklistExamId ON ExamChecklist(ExamId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxExamChecklistPhase ON ExamChecklist(ExamId, Phase)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxExamChecklistSubmissionType ON ExamChecklist(SubmissionType)");
    }
    ...
    private static function createExamRubricTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxExamRubricExamId ON ExamRubric(ExamId)");
    }
    ...
    private static function createParticipantTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxParticipantExamId ON Participant(ExamId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxParticipantEmail ON Participant(Email)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxParticipantStatus ON Participant(Status)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxParticipantProgressPercent ON Participant(ProgressPercent)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxParticipantUserId ON Participant(UserId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxParticipantTrackingId ON Participant(TrackingId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxParticipantSoftDeadlineDate ON Participant(SoftDeadlineDate)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxParticipantHardDeadlineDate ON Participant(HardDeadlineDate)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxParticipantAccessMethod ON Participant(AccessMethod)");
    }
    ...
    private static function createProgressTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxProgressParticipantId ON Progress(ParticipantId)");
    }
    ...
    private static function createExtensionRequestTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxExtensionRequestParticipantId ON ExtensionRequest(ParticipantId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxExtensionRequestStatus ON ExtensionRequest(Status)");
    }
    ...
    private static function createParticipantChecklistTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxParticipantChecklistParticipantId ON ParticipantChecklist(ParticipantId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxParticipantChecklistReviewStatus ON ParticipantChecklist(ReviewStatus)");
    }
    ...
    private static function createNotificationTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxNotificationUserId ON Notification(UserId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxNotificationIsRead ON Notification(IsRead)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxNotificationType ON Notification(Type)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxNotificationCreatedAt ON Notification(CreatedAt)");
    }
    ...
    private static function createAuditLogTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxAuditLogEventType ON AuditLog(EventType)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxAuditLogEventCategory ON AuditLog(EventCategory)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxAuditLogActorId ON AuditLog(ActorId)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxAuditLogTargetEntityType ON AuditLog(TargetEntityType)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxAuditLogCreatedAt ON AuditLog(CreatedAt)");
    }
    ...
    private static function createRateLimitTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxRateLimitIpAddressHash ON RateLimit(IpAddressHash)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxRateLimitCategory ON RateLimit(Category)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxRateLimitWindowEnd ON RateLimit(WindowEnd)");
    }
    ...
    private static function createRateLockoutTable(PDO $pdo): void {
        ...
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxRateLockoutIpAddressHash ON RateLockout(IpAddressHash)");
        $pdo->exec("CREATE INDEX IF NOT EXISTS IdxRateLockoutLockedUntil ON RateLockout(LockedUntil)");
    }
...
- [ ] Index names follow `Idx{Table}{Column}` convention
...
private static function createThemeTable(PDO $pdo): void {
    ...
    $pdo->exec("CREATE INDEX IF NOT EXISTS IdxThemeScope ON Theme(Scope)");
    $pdo->exec("CREATE INDEX IF NOT EXISTS IdxThemeIsActive ON Theme(IsActive)");
}
```
...
private static function createThemeOverrideTable(PDO $pdo): void {
    ...
    $pdo->exec("CREATE INDEX IF NOT EXISTS IdxThemeOverrideThemeId ON ThemeOverride(ThemeId)");
    $pdo->exec("CREATE INDEX IF NOT EXISTS IdxThemeOverrideExamId ON ThemeOverride(ExamId)");
}
```
...
private static function createCacheMetaTable(PDO $pdo): void {
    ...
    $pdo->exec("CREATE INDEX IF NOT EXISTS IdxCacheMetaExpiresAt ON CacheMeta(ExpiresAt)");
}
...
private static function createFeatureFlagTable(PDO $pdo): void {
    ...
    $pdo->exec("CREATE INDEX IF NOT EXISTS IdxFeatureFlagFlagKey ON FeatureFlag(FlagKey)");
    $pdo->exec("CREATE INDEX IF NOT EXISTS IdxFeatureFlagCategory ON FeatureFlag(Category)");
}
...
private static function createFeatureFlagOverrideTable(PDO $pdo): void {
    ...
    $pdo->exec("CREATE INDEX IF NOT EXISTS IdxFeatureFlagOverrideLookup ON FeatureFlagOverride(FlagKey, OverrideType, TargetId)");
    $pdo->exec("CREATE INDEX IF NOT EXISTS IdxFeatureFlagOverrideExpiresAt ON FeatureFlagOverride(ExpiresAt)");
}
```
...
|-------|------|--------------|
| **ER Diagram** | [diagrams/01-database-er-diagram](../../03-diagrams/01-database-er-diagram.md) | Visual table relationships |
