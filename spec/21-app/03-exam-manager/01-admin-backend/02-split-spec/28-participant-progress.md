...
CREATE INDEX IdxParticipantChecklistParticipantId ON ParticipantChecklist(ParticipantId);
CREATE INDEX IdxParticipantChecklistReviewStatus ON ParticipantChecklist(ReviewStatus);
```
...
CREATE INDEX IdxParticipantMilestoneLookup ON ParticipantMilestone(ParticipantId, MilestoneType);
```
