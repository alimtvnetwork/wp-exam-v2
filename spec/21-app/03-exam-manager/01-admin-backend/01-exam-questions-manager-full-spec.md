...
| **ORM-Based Database** | No raw SQL, PascalCase field names, prepared statements |
...
- **Code Standards**: Enums for all constants, `is`/`has` prefix for booleans, PascalCase database fields, ORM usage, no raw SQL
...
- [ ] Database fields use PascalCase
