...
**Files Changed**: 
- `Spec/02-frontend/02-split-spec/03-signup-flow.md`
...
**Files Changed**: 
- `Spec/01-admin-backend/02-split-spec/27-participant-service.md`
- `Spec/01-admin-backend/02-split-spec/36-rest-api-endpoints.md`
...
**Files Changed**: 
- `Spec/01-admin-backend/02-split-spec/04-database-schema.md`
...
**Files Changed**: 
- `Spec/02-frontend/02-split-spec/22-ui-design-system.md`
