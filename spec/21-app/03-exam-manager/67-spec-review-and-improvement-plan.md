...
| # | Task | File(s) to Modify | Effort |
|---|------|-------------------|--------|
| 7 | Split Frontend Spec into 25 files | `Spec/02-frontend/02-split-spec/` | 3 hours |
...
**File**: `Spec/01-admin-backend/02-split-spec/29-deadline-engine.md`
...
**File**: `Spec/01-admin-backend/02-split-spec/27-participant-service.md`
...
**File**: `Spec/01-admin-backend/02-split-spec/12-exam-service.md`
...
**New File**: `Spec/01-admin-backend/02-split-spec/48-rate-limiting.md`
...
**File**: `Spec/01-admin-backend/02-split-spec/35-plugin-settings.md`
...
**File**: `Spec/01-admin-backend/02-split-spec/28-participant-progress.md`
...
**File**: `Spec/02-frontend/02-split-spec/22-ui-design-system.md`
**Add**:
...
**File**: `Spec/02-frontend/02-split-spec/22-ui-design-system.md` (new section 22.4+)
**Add**:
...
**File**: NEW `Spec/02-frontend/02-split-spec/26-internationalization.md`
**Add**:
...
**File**: NEW `Spec/02-frontend/02-split-spec/27-performance-targets.md`
**Add**:
...
**File**: `Spec/01-admin-backend/02-split-spec/41-testing-requirements.md` (append)
**Add**:
...
- 📐 [diagrams/](03-diagrams/) - All visual diagrams
...
- ⚙️ [01-admin-backend/02-split-spec/](01-admin-backend/02-split-spec/) - All 64 backend specs
- 🖥️ [02-frontend/02-split-spec/](02-frontend/02-split-spec/) - All 33 frontend specs
