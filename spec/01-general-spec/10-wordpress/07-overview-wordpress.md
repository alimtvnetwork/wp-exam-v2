...
> **Documents:** 6 (01-06)  
> **Prerequisite:** Familiarity with `spec/01-general-spec/` foundation documents (01-foundation, 02-systems) recommended  
...
This folder contains **WordPress-specific coding guidelines** for plugin development. These guidelines build upon the foundation patterns in `spec/01-general-spec/` and adapt them to WordPress conventions, APIs, and best practices.
...
[Paste contents of spec/01-general-spec/10-wordpress/ folder]
...
[Paste spec/01-general-spec/01-foundation/ and spec/01-general-spec/02-systems/]

PART 2 - WORDPRESS SPECIFIC (read second):
[Paste spec/01-general-spec/10-wordpress/]
...
Same 3-tier pattern from `spec/01-general-spec/`, adapted for WordPress:
...
These WordPress guidelines extend the following `spec/01-general-spec/` documents:
...
## 12. Debugging & Error Resolution

WordPress plugins MUST follow the debugging patterns from the Error Resolution specification:

| Document | Purpose |
|----------|---------|
| [Error Resolution Overview](../../04-error-resolution/00-overview.md) | Verification patterns |
| [PHP Debugging Guide](../../04-error-resolution/03-debugging-guides/01-debugging-php.md) | Initialization order |
| [PHP Coding Guidelines](../../11-spec-management-software/12-prompts/01-coding-guideline/04-backend-php.md) | Boolean helpers, simplicity patterns |

### Mandatory Verification Pattern

Before claiming any API endpoint works:
1. Verify backend response format
2. Verify frontend expectation
3. Never assume - always check actual code
...
| PHP Debugging | `../../04-error-resolution/03-debugging-guides/01-debugging-php.md` |
