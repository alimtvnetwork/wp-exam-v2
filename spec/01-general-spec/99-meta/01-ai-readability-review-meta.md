...
### spec/01-general-spec/ vs spec/30-wp-plugin/03-exam-manager/
...
| **Index Naming** | Idx{Table}{Column} | Idx{Table}{Column} | ✅ **SYNCHRONIZED** |
...
```go
// Go example — use generics instead of interface{}
