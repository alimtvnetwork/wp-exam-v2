...
`error-resolution`, `retrospective`, `api-debugging`, `root-cause-analysis`
...
|---|------|-------|-------------|
| 01 | [01-health-endpoint-mismatch.md](./01-health-endpoint-mismatch.md) | Frontend expected `{success:true}` but backend returned `{status:"healthy"}` | ~1 hour |
